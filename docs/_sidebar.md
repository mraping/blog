...
* 工具脚本
    ...
    - [netsh windows7 自带端口映射（转发）使用教程](/工具脚本/netsh windows7 自带端口映射（转发）使用教程.md)
...
* 其它资料
    - [java IO流读取图片供前台显示](/其它资料/java IO流读取图片供前台显示.md)
    - [编码规范](/其它资料/编码规范.md)
    - [Kubernetes](/其它资料/Kubernetes.md)
    - [微服务架构](/其它资料/微服务架构.md)
    - [Cookie的记录](/其它资料/Cookie的记录.md)
    - [闲话 CDN](/其它资料/闲话 CDN.md)
    ...
    - [ Mac下使用 ngrok 实现内网穿透](/其它资料/ Mac下使用 ngrok 实现内网穿透.md)
    ...
    - [Git命令](/其它资料/Git命令.md)
    - [RPC概览](/其它资料/RPC概览.md)
    - [item2 配置环境变量不生效的解决](/其它资料/item2 配置环境变量不生效的解决.md)
...
* Java
    ...
    - [关于 j2ee 服务端用 System.out.println 是否影响性能的问题](/Java/关于 j2ee 服务端用 System.out.println 是否影响性能的问题.md)
...
* Interview
    - [distributed-system](/Interview/distributed-system)
    - [面试题](/Interview/面试题.md)
    - [如何设计可以动态扩容缩容的分库分表方案？](/Interview/如何设计可以动态扩容缩容的分库分表方案？.md)
    - [high-concurrency](/Interview/high-concurrency)
    ...
    - [high-availability](/Interview/high-availability)
* Linux
...
* spring
    ...
    - [Spring Bean的生命周期](/spring/Spring Bean的生命周期.md)